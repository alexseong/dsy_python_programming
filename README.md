...
| Week 4 | <ul><li>[Learn Python the Hard Way (ex 40-42)][5]</li><li>Extra: Learn Python the Hard Way ex 43</ul> | [OOP][5.2]<br>[Python Intro 3][5.3] | Alex Seong | [slides][5.1]  |

| Week 4 | <ul><li>[Intro to IPython Notebook][18]</li><li>[Python Syntax 2][4.1]</li></ul>| [Python Intro 4][6] | Alex Seong | [slides][6.1] |
